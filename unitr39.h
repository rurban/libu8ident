...
const struct sc_tr39 tr39_start_list[] = {
    ...
    {0x2EBF0, 0x2EE5D, SC_Han, GC_Lo, NULL}, //  𮯰..𮹝
    {0x30000, 0x3134A, SC_Han, GC_Lo, NULL}, //  𰀀..𱍊
    {0x31350, 0x323AF, SC_Han, GC_Lo, NULL}, //  𱍐..𲎯
}; // 246 ranges, 95 singles, 100801 codepoints
#else
extern const struct sc_tr39 tr39_start_list[341];
#endif
...
const struct sc_tr39 tr39_cont_list[] = {
    ...
    {0x660, 0x669, SC_Arabic, GC_Nd, "\x03\x1c\x86"}, //Arabic,Thaana,Yezidi //  ٠..٩
    {0x6F0, 0x6F9, SC_Arabic, GC_Nd, NULL}, //  ۰..۹
    {0x966, 0x96F, SC_Devanagari, GC_Nd, "\x08\x31\x41\x4c"}, //Devanagari,Dogra,Kaithi,Mahajani //  ०..९
    {0x9E6, 0x9EF, SC_Bengali, GC_Nd, "\x05\x8d\xa1"}, //Bengali,Chakma,Syloti_Nagri //  ০..৯
    {0xA66, 0xA6F, SC_Gurmukhi, GC_Nd, "\x0d\x58"}, //Gurmukhi,Multani //  ੦..੯
    {0xAE6, 0xAEF, SC_Gujarati, GC_Nd, "\x0c\x45"}, //Gujarati,Khojki //  ૦..૯
    {0xB66, 0xB6F, SC_Oriya, GC_Nd, NULL}, //  ୦..୯
    {0xBE6, 0xBEF, SC_Tamil, GC_Nd, "\x39\x1a"}, //Grantha,Tamil //  ௦..௯
    {0xC66, 0xC6F, SC_Telugu, GC_Nd, NULL}, //  ౦..౯
    {0xCE6, 0xCEF, SC_Kannada, GC_Nd, "\x13\x5b\x82"}, //Kannada,Nandinagari,Tulu_Tigalari //  ೦..೯
    ...
    {0x1040, 0x1049, SC_Myanmar, GC_Nd, "\x8d\x17\xa3"}, //Chakma,Myanmar,Tai_Le //  ၀..၉
    {0x1090, 0x1099, SC_Myanmar, GC_Nd, NULL}, //  ႐..႙
    {0x17E0, 0x17E9, SC_Khmer, GC_Nd, NULL}, //  ០..៩
    {0x203F, 0x2040, SC_Common, GC_Pc, NULL}, //  ‿..⁀
    {0x30FB, 0x30FB, SC_Common, GC_Po, "\x06\x0e\x0f\x11\x12\xa9"}, //Bopomofo,Hangul,Han,Hiragana,Katakana,Yi //  ・
    {0xA9F0, 0xA9F9, SC_Myanmar, GC_Nd, NULL}, //  ꧰..꧹
}; // 20 ranges, 2 singles, 172 codepoints
#else
extern const struct sc_tr39 tr39_cont_list[22];
#endif
...
const struct sc_tr39 tr39_excl_start_list[] = {
    ...
    {0x18D01, 0x18D08, SC_Tangut, GC_Lo, NULL}, //  (Excluded) 𘴁..𘴈
...
}; // 173 ranges, 41 singles, 19278 codepoints
#else
extern const struct sc_tr39 tr39_excl_start_list[214];
#endif
...
}; // 23 ranges, 0 singles, 207 codepoints
#else
extern const struct sc_tr39 tr39_excl_cont_list[23];
#endif
