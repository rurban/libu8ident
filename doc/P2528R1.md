...
* Disallow non-confusable `Technical`
...
error or just a warning. Since we do have the `-std=c26++` option, and
...
C++23 (and C26) will follow the TR39 Security Profile 4 **Moderately
...
marked as such. Such as U+1C0 ǀ, U+1C3 ǃ, ...
...
- **private**: Another argument would be that all exported names end
  ...
  prevent from confusables in struct/class fields/methods, and the
...
const struct sc_c26 safec26_start_list[470] = {
    {'$', '$', SC_Latin, GC_Sc, NULL},
