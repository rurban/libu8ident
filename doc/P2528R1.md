...
warnings on not-valid scripts, mixed scripts, or invalid sequences of
combining marks though, even if the Unicode Standard recommended for
decades that identifiers should stay identifiable.
