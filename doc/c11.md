...
identifers with a special profile, called TR39. This is an
extended Moderate Profile, plus allowing **Greek** scripts with Latin,
plus only allowing a special TR39 TR31 charset. You realistically only
...
**`U8ID_PROFILE_TR39_4`**, defined by `-DU8ID_PROFILE_TR39`. This is
...
See `unic11.h`, `unitr39.h` and `mktr39.c`.
...
then went more insecure by allowing all ID_Start and ID_Cont
characters.
