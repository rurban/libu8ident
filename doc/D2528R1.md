...
as last character in a word, but this set of identifiers contain none,
as we disallow the legacy Arabic Presentation forms.
...
reasons, disallowing their single character contribution to
identifiers. See
