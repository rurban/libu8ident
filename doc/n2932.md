...
in parallel to [P2528R1](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2022/P2528R1.html)
for C++.
...
`ID_Start` consists of Lu + Ll + Lt + Lm + Lo + Nl, +`Other_ID_Start`, -`Pattern_Syntax`, -`Pattern_White_Space`,-`Median`

131899 codepoints

`ID_Continue` consists of `ID_Start`, + Mn + Mc + Nd + Pc, +`Other_ID_Continue`, +`Median`, -`Pattern_Syntax`, -`Pattern_White_Space`.
