...
#else
extern const struct sc_c26 safec26_start_list[339];
#endif
...
const struct sc_c26 safec26_cont_list[] = {
    ...
    {0x660, 0x669, SC_Arabic, GC_Nd, "\x03\x1c\x7f"}, //Arabic,Thaana,Yezidi //  ٠..٩
    {0x6F0, 0x6F9, SC_Arabic, GC_Nd, NULL}, //  ۰..۹
    {0x966, 0x96F, SC_Devanagari, GC_Nd, "\x08\x31\x3f\x49"}, //Devanagari,Dogra,Kaithi,Mahajani //  ०..९
    {0x9E6, 0x9EF, SC_Bengali, GC_Nd, "\x05\x86\x9a"}, //Bengali,Chakma,Syloti_Nagri //  ০..৯
    {0xA66, 0xA6F, SC_Gurmukhi, GC_Nd, "\x0d\x55"}, //Gurmukhi,Multani //  ੦..੯
    {0xAE6, 0xAEF, SC_Gujarati, GC_Nd, "\x0c\x43"}, //Gujarati,Khojki //  ૦..૯
    ...
    {0xCE6, 0xCEF, SC_Kannada, GC_Nd, "\x13\x58"}, //Kannada,Nandinagari //  ೦..೯
    ...
    {0x1040, 0x1049, SC_Myanmar, GC_Nd, "\x86\x17\x9c"}, //Chakma,Myanmar,Tai_Le //  ၀..၉
...
}; // 163 ranges, 34 singles, 15005 codepoints
#else
extern const struct sc_c26 safec26_excl_start_list[197];
#endif
...
}; // 18 ranges, 0 singles, 162 codepoints
#else
extern const struct sc_c26 safec26_excl_cont_list[18];
#endif
