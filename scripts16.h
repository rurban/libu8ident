...
LOCAL const struct sc xid_script_list32[] = {
    ...
    // clang-format on
}; // 360 ranges, 51 single codepoints
#  else
extern const struct sc xid_script_list32[411];
#  endif
...
LOCAL const struct range_bool allowed_id_list32[] = {
    ...
    {0x31350, 0x323AF},
    // clang-format on
}; // 18 ranges, 5 single codepoints
#  else
extern const struct range_bool allowed_id_list32[23];
#  endif
#endif
...
LOCAL const struct range_bool NFKD_N_list32[] = {
    ...
    {0x2F800, 0x2FA1D},
    // clang-format on
}; // 65 ranges, 35 single codepoints
#    else
extern const struct range_bool NFKD_N_list32[100];
#    endif
#  endif
...
LOCAL const struct range_bool NFKC_N_list32[] = {
    ...
    {0x2F800, 0x2FA1D},
    // clang-format on
}; // 61 ranges, 30 single codepoints
#    else
extern const struct range_bool NFKC_N_list32[91];
#    endif
#  endif
