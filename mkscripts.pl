...
# * An optimized all-in-one start/cont list for TR39, without Excluded and Limited_Use scripts,
...
my ($started, @IDTYPES, @ALLOWED, @IDSTART, @IDCONT, @XIDSTART, @XIDCONT,
    @TR39START, @TR39CONT, %GCONFUS, @GCONFUS);
...
// Greek-Latin confusables. See doc/P2538R0.md (Appendix F - Greek Confusables) for TR39
#ifdef EXTERN_SCRIPTS
