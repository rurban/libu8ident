...
printf $H "  GC_L, // is L&, all letters. (for unitr39.h only)\n";
printf $H "  GC_V, // is varying, eg L or S. (for unitr39.h only),\n";
printf $H "  GC_INVALID,\n";
...
printf $H "  \"L\", // L& really (for unitr39.h only)\n";
printf $H "  \"V\", // varying (for unitr39.h only)\n";
printf $H "  \"Zz\"\n";
printf $H <<'EOF';
};
#endif
